...
import edu.fiuba.algo3.vista.ContenedorComienzo;
...
public class ControladorBienvenida {
    ...
    public void onClick(ActionEvent event) {
        ...
        if (value == "JUGAR") {
            ContenedorComienzo contenedorComienzo = new ContenedorComienzo();
            contenedorComienzo.setMensaje();
            Scene escenaJuego = new Scene(contenedorComienzo, 1280, 720);

...
public class BotonViajeACiudad implements EventHandler<ActionEvent> {
    ...
    public void handle(ActionEvent eventoNuevo) {
        ...
        Scene nuevaEscena;
        //if (nuevaCiudad.getCiudadSiguiente() == null && nuevaCiudad.getPasoLadron()){
        //    ContenedorBienvenida nuevoContenedor = new ContenedorBienvenida(stage);
        //    nuevaEscena = new Scene(nuevoContenedor, 1280, 720);
        //}
        //else {

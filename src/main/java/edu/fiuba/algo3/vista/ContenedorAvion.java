...
public class ContenedorAvion extends AnchorPane {
    ...
    public void modelar(){
        ...
        if (ciudadesDisponibles.size() == 3){
            ...
            boton1.setStyle("-fx-pref-width: 500; -fx-pref-height: 70;-fx-background-color: #E74C3C; -fx-background-radius: 15; -fx-text-alignment: CENTER");
            ...
            boton2.setStyle("-fx-pref-width: 500; -fx-pref-height: 70;-fx-background-color: #E74C3C; -fx-background-radius: 15; -fx-text-alignment: CENTER");
            ...
            boton3.setStyle("-fx-pref-width: 500; -fx-pref-height: 70;-fx-background-color: #E74C3C; -fx-background-radius: 15; -fx-text-alignment: CENTER");
        ...
        AnchorPane.setTopAnchor(contenedorCiudades, 150.0);
        AnchorPane.setBottomAnchor(contenedorCiudades, 100.0);
        AnchorPane.setRightAnchor(contenedorCiudades, 100.0);
        AnchorPane.setLeftAnchor(contenedorCiudades, 150.0);

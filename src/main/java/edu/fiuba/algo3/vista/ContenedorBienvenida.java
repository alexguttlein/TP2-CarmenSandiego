...
public class ContenedorBienvenida extends AnchorPane {
    ...
    public void modelar() {
        ...
        buttonJugar.setStyle("-fx-background-color: #ADFF2F; -fx-pref-height: 70; -fx-pref-width: 300");
        buttonJugar.setFont(font);
        buttonJugar.setLayoutX(278);
        buttonJugar.setLayoutY(601);

        buttonSalir.setStyle("-fx-background-color: #FF0000; -fx-pref-height: 70; -fx-pref-width: 300");
